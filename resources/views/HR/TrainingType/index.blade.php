		...
		@endif
			...
			<div class="page-header">
				<div class="row align-items-center">
					<div class="col">
						<h3 class="page-title">All Training Type</h3>
						<ul class="breadcrumb">
					...
					<div class="col-auto float-right ml-auto">
						<a href="{{ route('trainingtype.create') }}" class="btn add-btn"  data-target="#add_leave"><i class="fa fa-plus"></i> Add Training Type</a>
					</div>
				</div>
			</div>
			<!-- /Page Header -->
									...
									<td class="text-right">
										<div class="dropdown dropdown-action">
											...
											<div class="dropdown-menu dropdown-menu-right">
								                ...
								                <a href="{{ route('trainingtype.edit', $row->id) }}" class="dropdown-item"   data-target="#edit_leave">Edit</a>
												<a href="#" class="dropdown-item" onclick="handleDelete({{ $row->id }})">Delete</a>
												<!-- Delete Form -->
												<form id="deleteForm_{{ $row->id }}" action="{{ route('trainingtype.destroy', $row->id) }}" method="post">
													@csrf
													@method('DELETE')
												</form>
											</div>
